...
| Nastaran Moradi         | Frontend & UI Developer                     | Design and implementation of the interactive Streamlit interface, user input vialidation, and output visualization (`app.py`)                                                            |
